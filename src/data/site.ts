// Toggle visibility of sections (true = visible, false = hidden)
...
export const site = {
  ...
  formspreeID: 'xeegwavv',
  image: '/img/gobi.PNG',

  // Leadership Philosophy
  philosophy: {
    headline: 'My Leadership Philosophy',
    quote: "I don't lead from above — I lead beside. I mentor, share, and build shoulder-to-shoulder with my teams.",
    principles: [
      {
        title: 'People-First',
        description: 'Great leadership is about empowerment, not control. I invest in growing people.',
      },
      {
        title: 'Lead by Example',
        description: 'I jump in where needed and ensure no one is left behind — even if it means extra hours.',
      },
      {
        title: 'Servant Leadership',
        description: 'I believe in teaching, mentoring, and evolving with the team rather than commanding from the top.',
      },
    ],
  },
  ...
  aspiration: {
    ...
    description: 'Building toward a future where technical depth, people-first leadership, and product thinking converge to create strategic impact at scale.',
  ...
  // Community & Mentoring
  mentoring: {
    headline: 'Community & Mentoring',
    quote: 'Growing people is as important as shipping products.',
    activities: [
      {
        title: 'Drupal Project Mentor',
        duration: '10 years',
        period: '2014 - 2024',
      ...
      },
      {
        ...
        duration: 'Ongoing',
        period: '2022 - Present',
        description: 'Guiding Computer Science students from classroom concepts to deployment-ready professionals.',
      },
    ],
  },
  ...
  social: {
    linkedin: 'https://www.linkedin.com/in/gobinathm/',
    github: 'https://github.com/gobinathm',
    medium: 'https://medium.com/@gobinathm',
    stackoverflow: 'https://stackoverflow.com/users/1288968/gobinath-mallaiyan',
    instagram: 'https://www.instagram.com/gobinathm/',
    twitter: 'https://twitter.com/gobinathm',
    fivehundredpx: 'https://500px.com/p/gobinathm',
    strava: 'https://www.strava.com/athletes/10286114',
    goodreads: 'https://www.goodreads.com/user/show/12583429-gobinath-mallaiyan',
    storygraph: 'https://app.thestorygraph.com/profile/gobinathm',
  },
  externalLinks: {
    blog: 'https://medium.com/@gobinathm',
    notes: 'https://notes.gobinath.com',
  },
};
